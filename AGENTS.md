...
## Improvements vs previous AGENTS.md

- Replaced generic placeholders (e.g., “(tool name)”, “(testing framework)”, `make test`) with commands that exist in this repo.
- Added the actual dev/build workflows and the SvelteKit `frontend` toolchain.
- Summarized the real backend/frontend architecture and the authoritative role policy.
